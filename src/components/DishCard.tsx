...
export function DishCard({ dish, category, language }: DishCardProps) {
  ...
  return (
    <article className="group max-sm:snap-start max-sm:snap-normal overflow-hidden rounded-[1.35rem] border border-white/10 bg-taupe shadow-glow transition duration-300 hover:-translate-y-1 hover:border-gold/50 sm:rounded-[1.65rem]">
